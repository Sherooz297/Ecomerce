...
const { newOrder, getSingleOrder, getLoginUserOrder, getallordets, updateOrder, deleteOrder } = require('../controller/orderController')


router.route("/order/new").post(isAuthenticationUser,newOrder)
router.route("/orders/:id").get(isAuthenticationUser,getSingleOrder)
router.route("/orders/me").get(isAuthenticationUser,getLoginUserOrder)
